...
<a href="mailto:developernishanthsiraj@gmail.com">
...
- 💞️ Open to collaborating on **big, meaningful projects**
- 📫 Reach me at **developernishanthsiraj@gmail.com**
...
<img src="https://skillicons.dev/icons?i=python,django,vue,redis,postgres,docker,git,firebase&theme=dark" />

<br/><br/>

`Django REST Framework` &nbsp;·&nbsp; `Celery` &nbsp;·&nbsp; `Ollama` &nbsp;·&nbsp; `HuggingFace` &nbsp;·&nbsp; `LangChain` &nbsp;·&nbsp; `CrewAI`
